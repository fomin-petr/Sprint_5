...
def test_login_in_main_page(registration, start_page, random_email, random_password):
    driver = start_page
...
def test_login_by_click_private_page(start_page, random_email, random_password):
    driver = start_page
...
def test_login_from_registration_page(start_page, random_email, random_password):
    driver = start_page
    driver.find_element(By.XPATH, StartPageLocators.LOGIN_BUTTON).click()
    WebDriverWait(driver, 3).until(
...
def test_login_from_password_recovery(start_page, random_email, random_password):
    driver = start_page
    driver.find_element(By.XPATH, StartPageLocators.LOGIN_BUTTON).click()
    WebDriverWait(driver, 3).until(
        expected_conditions.visibility_of_element_located((By.XPATH, LoginPageLocators.REGISTRATION_BUTTON)))
