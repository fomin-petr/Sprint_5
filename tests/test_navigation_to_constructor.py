...
def test_navigation_to_constructor_by_click_in_private_page(registration, start_page, random_email, random_password):
    driver = start_page
...
def test_navigation_to_constructor_by_click_logo_in_private_page(start_page, random_email, random_password):
    driver = start_page
    driver.find_element(By.XPATH, StartPageLocators.PRIVATE_PAGE_BUTTON).click()
    WebDriverWait(driver, 3).until(
        expected_conditions.visibility_of_element_located((By.XPATH, LoginPageLocators.LOGIN_BUTTON)))
